    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Covered Line Add</h3>
            </div>
            <?php echo form_open('covered_line/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="fk_file_id" class="form-control">
								...
								{
									$selected = ($vulnerable_file['id'] == $this->input->post('fk_file_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="run" value="<?php echo $this->input->post('run'); ?>" class="form-control" id="run" />
						</div>
					</div>
				</div>
			</div>
