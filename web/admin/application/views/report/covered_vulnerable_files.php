    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Vulnerable Files Listing:
                  <?php echo count($vulnerable_files) ?> items
                  <?php
                  if (isset($trigerred_vulnerable_file_ids)) {
                    echo '('.count($trigerred_vulnerable_file_ids).'/'.count($vulnerable_files).' triggered)';
                  } ?></h3>
            ...
            <th>Software</th>
						<th>Version</th>
            <th>File Name</th>
            <?php if (isset($trigerred_vulnerable_file_ids)) echo "<th>Triggered</th>" ?>
						<th>Actions</th>
                </tr>
