    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Edit Vulnerable Line</h3>
            </div>
			<?php echo form_open('vulnerable_line/edit/'.$vulnerable_line['id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="fk_vulnerability_software" id="fk_vulnerability_software" class="form-control">
								...
								{
									$selected = ($vulnerability_software['id'] == $vulnerable_line['fk_vulnerability_software']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="fk_vulnerable_file" id="fk_vulnerable_file" class="form-control">
								...
								{
									$selected = ($vulnerable_file['id'] == $vulnerable_line['fk_vulnerable_file']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="line_number" value="<?php echo ($this->input->post('line_number') ? $this->input->post('line_number') : $vulnerable_line['line_number']); ?>" class="form-control" id="line_number" />
						</div>
					</div>
				</div>
			</div>
