// ==UserScript==
// @name     mwk_1211_GremlinsJS
// @version  1
// @grant    none
// @include  http://localhost:8085/mediawiki-1.21.1/*
...
$(document).ready(function(){
    ...
    setCookie('test_group','mwk1211_monkey_test', 1, 'mediawiki-1.21.1');
    setCookie('test_name','mwk1211_gremlinsjs_loggedin', 1, 'mediawiki-1.21.1');
    setCookie('software_id','2', 1, 'mediawiki-1.21.1');
    setCookie('software_version_id','6', 1, 'mediawiki-1.21.1');
