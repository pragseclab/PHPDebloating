// ==UserScript==
// @name     wp_460_GremlinsJS
// @version  1
// @grant    none
// @include  http://localhost:8085/WordPress-4.6/*
...
$(document).ready(function(){
    ...
    setCookie('test_group','wp460_monkey_test', 1, 'WordPress-4.6');
    setCookie('test_name','wp460_gremlinsjs', 1, 'WordPress-4.6');
    setCookie('software_id','4', 1, 'WordPress-4.6');
    setCookie('software_version_id','18', 1, 'WordPress-4.6');
