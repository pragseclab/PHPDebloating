// ==UserScript==
// @name     wp_400_GremlinsJS
// @version  1
// @grant    none
// @include  http://localhost:8085/WordPress-4.0/*
...
$(document).ready(function(){
    ...
    setCookie('test_group','wp400_monkey_test', 1, '/WordPress-4.0');
    setCookie('test_name','wp400_gremlinsjs', 1, '/WordPress-4.0');
    setCookie('software_id','4', 1, '/WordPress-4.0');
    setCookie('software_version_id','16', 1, '/WordPress-4.0');
