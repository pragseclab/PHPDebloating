...
function setCookies() {
    setCookie('test_group','pma400_form_fuzzer', 1, '/phpMyAdmin-4.0.0-all-languages');
    setCookie('test_name','pma400_form_fuzzer', 1, '/phpMyAdmin-4.0.0-all-languages');
