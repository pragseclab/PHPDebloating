...
$(document).ready(function(){
    ...
    setCookie('test_group','pma440_monkey_test', 1, 'phpMyAdmin-4.4.0-all-languages');
    setCookie('test_name','pma440_gremlinsjs_loggedin', 1, 'phpMyAdmin-4.4.0-all-languages');
...
setTimeout(function(){
  horde.stop();
  window.location = "http://localhost:8085/phpMyAdmin-4.4.0-all-languages/";
}, 120000);
