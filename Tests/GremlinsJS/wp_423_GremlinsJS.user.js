// ==UserScript==
// @name     wp_423_GremlinsJS
// @version  1
// @grant    none
// @include  http://localhost:8085/WordPress-4.2.3/*
...
$(document).ready(function(){
    ...
    setCookie('test_group','wp423_monkey_test', 1, 'WordPress-4.2.3');
    setCookie('test_name','wp423_gremlinsjs', 1, 'WordPress-4.2.3');
    setCookie('software_id','4', 1, 'WordPress-4.2.3');
    setCookie('software_version_id','17', 1, 'WordPress-4.2.3');
