// ==UserScript==
// @name     wp_470_GremlinsJS
// @version  1
// @grant    none
// @include  http://localhost:8085/WordPress-4.7/*
...
$(document).ready(function(){
    ...
    setCookie('test_group','wp470_monkey_test', 1, 'WordPress-4.7');
    setCookie('test_name','wp470_gremlinsjs', 1, 'WordPress-4.7');
    setCookie('software_id','4', 1, 'WordPress-4.7');
    setCookie('software_version_id','19', 1, 'WordPress-4.7');
