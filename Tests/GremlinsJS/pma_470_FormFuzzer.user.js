...
function setCookies() {
    setCookie('test_group','pma470_form_fuzzer', 1, '/phpMyAdmin-4.7.0-all-languages');
    setCookie('test_name','pma470_form_fuzzer', 1, '/phpMyAdmin-4.7.0-all-languages');
