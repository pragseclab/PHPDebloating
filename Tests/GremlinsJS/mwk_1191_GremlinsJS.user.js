// ==UserScript==
// @name     mwk_1191_GremlinsJS
// @version  1
// @grant    none
// @include  http://localhost:8085/mediawiki-1.19.1/*
...
$(document).ready(function(){
    ...
    setCookie('test_group','mwk1191_monkey_test', 1, 'mediawiki-1.19.1');
    setCookie('test_name','mwk1191_gremlinsjs_loggedout', 1, 'mediawiki-1.19.1');
    setCookie('software_id','2', 1, 'mediawiki-1.19.1');
    setCookie('software_version_id','5', 1, 'mediawiki-1.19.1');
