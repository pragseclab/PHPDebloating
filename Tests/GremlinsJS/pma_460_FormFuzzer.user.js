...
function setCookies() {
    setCookie('test_group','pma460_form_fuzzer', 1, '/phpMyAdmin-4.6.0-all-languages');
    setCookie('test_name','pma460_form_fuzzer', 1, '/phpMyAdmin-4.6.0-all-languages');
