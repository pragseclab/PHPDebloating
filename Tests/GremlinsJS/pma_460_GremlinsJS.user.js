// ==UserScript==
// @name     pma_460_GremlinsJS
// @version  1
// @grant    none
// @include  http://localhost:8085/phpMyAdmin-4.6.0-all-languages/*
...
$(document).ready(function(){
    $( 'a' ).each(function() {
        ...
        if(this.href.indexOf('old_usr') != -1){ // Remove logout link
            $(this).empty();
        }
    });
    setCookie('test_group','pma460_monkey_test', 1, 'phpMyAdmin-4.6.0-all-languages');
    setCookie('test_name','pma460_gremlinsjs_loggedin', 1, 'phpMyAdmin-4.6.0-all-languages');
    setCookie('software_id','1', 1, 'phpMyAdmin-4.6.0-all-languages');
    setCookie('software_version_id','3', 1, 'phpMyAdmin-4.6.0-all-languages');
...
setTimeout(function(){
  ...
  window.location = "http://localhost:8085/phpMyAdmin-4.6.0-all-languages/";
}, 120000);
