// ==UserScript==
// @name     pma_400_GremlinsJS
// @version  1
// @grant    none
// @include  http://localhost:8085/phpMyAdmin-4.0.0-all-languages/*
...
$(document).ready(function(){
    ...
    setCookie('test_group','pma400_monkey_test', 1, 'phpMyAdmin-4.0.0-all-languages');
    setCookie('test_name','pma400_gremlinsjs_loggedin', 1, 'phpMyAdmin-4.0.0-all-languages');
    setCookie('software_id','1', 1, 'phpMyAdmin-4.0.0-all-languages');
    setCookie('software_version_id','1', 1, 'phpMyAdmin-4.0.0-all-languages');
...
setTimeout(function(){
  horde.stop();
  window.location = "http://localhost:8085/phpMyAdmin-4.0.0-all-languages/";
}, 120000);
