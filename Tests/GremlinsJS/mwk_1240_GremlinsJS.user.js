// ==UserScript==
// @name     mwk_1240_GremlinsJS
// @version  1
// @grant    none
// @include  http://localhost:8085/mediawiki-1.24.0/*
...
$(document).ready(function(){
    ...
    setCookie('test_group','mwk1240_monkey_test', 1, 'mediawiki-1.24.0');
    setCookie('test_name','mwk1240_gremlinsjs_loggein', 1, 'mediawiki-1.24.0');
    setCookie('software_id','2', 1, 'mediawiki-1.24.0');
    setCookie('software_version_id','8', 1, 'mediawiki-1.24.0');
