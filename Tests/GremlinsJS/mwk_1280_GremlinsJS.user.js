// ==UserScript==
// @name     mwk_1280_GremlinsJS
// @version  1
// @grant    none
// @include  http://localhost:8085/mediawiki-1.28.0/*
...
$(document).ready(function(){
    ...
    setCookie('test_group','mwk1280_monkey_test', 1, 'mediawiki-1.28.0');
    setCookie('test_name','mwk1280_gremlinsjs_loggedout', 1, 'mediawiki-1.28.0');
    setCookie('software_id','2', 1, 'mediawiki-1.28.0');
    setCookie('software_version_id','9', 1, 'mediawiki-1.28.0');
