...
class MediaWikiTests:
    def __init__(self):
        self.main_page = 'http://localhost:8085/mediawiki-1.21.1/'
    ...
    def add_cookies(self):
        ...
        self.driver.add_cookie({'name': 'test_group', 'value': 'mwk1211_tutorials'})
        self.driver.add_cookie({'name': 'test_name', 'value': 'mwk_loginmwk1211_tutorials'})
        self.driver.add_cookie({'name': 'software_id', 'value': '2'})
        self.driver.add_cookie({'name': 'software_version_id', 'value': '6'})
...
== Getting started ==
123
[[image:/mediawiki-1.21.1/resources/assets/wiki.png]]
[[Category: category_1]]
[[Category: category_2]]
[[Category: category_3]]''')
