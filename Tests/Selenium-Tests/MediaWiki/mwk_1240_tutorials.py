...
class MediaWikiTests:
    def __init__(self):
        self.main_page = 'http://localhost:8085/mediawiki-1.24.0/'
    ...
    def add_cookies(self):
        ...
        self.driver.add_cookie({'name': 'test_group', 'value': 'mwk1240_tutorials'})
        self.driver.add_cookie({'name': 'test_name', 'value': 'mwk_loginmwk1240_tutorials'})
        self.driver.add_cookie({'name': 'software_id', 'value': '2'})
        self.driver.add_cookie({'name': 'software_version_id', 'value': '8'})
...
== Getting started ==
123
[[image:/mediawiki-1.24.0/resources/assets/wiki.png]]
[[Category: category_1]]
[[Category: category_2]]
[[Category: category_3]]''')
    ...
    def create_page(self):
        ...
        try :
            ...
            # Create new page
            self.click_element('//*[@id="mw-content-text"]/div/p[2]/strong/a')
            self.fill_textbox('//*[@id="wpTextbox1"]', '''
...
** Saturday|Saturday''')
    ...
    def change_import_export(self):
        ...
        try :
            ...
            #self.fill_textbox('//*[@id="xmlimport"]', '/home/babak/Documents/XS-Shredder-PHP/database/mwk1240-20180724200620.xml')
            self.click_element('//*[@id="mw-import-table-upload"]/tbody/tr[4]/td[2]/input')
