...
class MediaWikiTests:
    def __init__(self):
        self.main_page = 'http://localhost:8085/mediawiki-1.23.0/'
    ...
    def add_cookies(self):
        ...
        self.driver.add_cookie({'name': 'test_group', 'value': 'mwk1230_tutorials'})
        self.driver.add_cookie({'name': 'test_name', 'value': 'mwk_loginmwk1230_tutorials'})
        self.driver.add_cookie({'name': 'software_id', 'value': '2'})
        self.driver.add_cookie({'name': 'software_version_id', 'value': '7'})
    ...
    def rename_page(self):
        ...
        # Fill form fields
        try :
            self.click_element('//*[@id="p-cactions-label"]/a')
...
== Getting started ==
123
[[image:/mediawiki-1.23.0/resources/assets/wiki.png]]
[[Category: category_1]]
[[Category: category_2]]
[[Category: category_3]]''')
