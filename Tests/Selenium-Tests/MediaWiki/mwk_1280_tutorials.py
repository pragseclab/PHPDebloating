...
class MediaWikiTests:
    def __init__(self):
        self.main_page = 'http://localhost:8085/mediawiki-1.28.0/'
    ...
    def add_cookies(self):
        ...
        self.driver.add_cookie({'name': 'test_group', 'value': 'mwk1280_tutorials'})
        self.driver.add_cookie({'name': 'test_name', 'value': 'mwk_loginmwk1280_tutorials'})
        self.driver.add_cookie({'name': 'software_id', 'value': '2'})
        self.driver.add_cookie({'name': 'software_version_id', 'value': '9'})
    ...
    def rename_page(self):
        ...
        # Fill form fields
        try :
            self.click_element('//*[@id="p-cactions-label"]/span')
            self.click_element('//*[@id="ca-move"]/a')

            self.fill_textbox('//*[@id="wpNewTitleMain"]/input', 'Main Page_' + ''.join(random.choice(string.digits) for _ in range(5)))
            self.click_element('//*[@id="mw-movepage-table"]/div/div[4]/div/div/div/button/span[2]')
...
== Getting started ==
123
[[image:/mediawiki-1.28.0/resources/assets/wiki.png]]
[[Category: category_1]]
[[Category: category_2]]
[[Category: category_3]]''')
    ...
    def create_account(self):
        ...
        print "[+] Starting create account process..."
        self.driver.get(self.main_page)
        # Fill form fields
        try :
            self.click_element('//*[@id="pt-createaccount"]/a')
    ...
    def create_page(self):
        ...
        try :
            ...
            self.click_element('//*[@id="searchButton"]')

            # Create new page
            self.click_element('//*[@id="mw-content-text"]/div/p[1]/strong/a')
            self.fill_textbox('//*[@id="wpTextbox1"]', '''
...
** Saturday|Saturday''')
    ...
    def change_import_export(self):
        ...
        # Fill form fields
        try :
            self.fill_textbox('//*[@id="mw-input-catname"]/input', 'Category_1')
            self.click_element('//*[@id="ooui-1"]/button')
            self.click_element('//*[@id="ooui-6"]/button/span[2]')
            ...
            self.fill_textbox('//*[@id="xmlimport"]', file_path + '/Tests/Selenium-Tests/MediaWiki/mwk1191-20190202134027.xml')
            self.click_element('//*[@id="mw-import-table-upload"]/tbody/tr[6]/td[2]/input')
