...
class MagentoTests:
    def __init__(self):
        # UPDATE HERE (1/5)
        self.main_page = 'http://localhost:7075/magento-2.0.5/'
        self.admin_page = 'http://localhost:7075/magento-2.0.5/admin'
    ...
    def click_element(self, xpath_selector, direct=False):
        try:
            time.sleep(1)
            if not direct:
    ...
    def wait_for_loading_message(self):
        if self.check_exists_and_visible_by_xpath('//span[@title="Close popup"]'):
            self.click_element('//span[@title="Close popup"]', direct=True) # Close admin notification pop ups
        elif self.check_exists_and_visible_by_xpath('//button[@data-role="closeBtn"]'):
            self.click_element('//button[@data-role="closeBtn"]', direct=True) # Close clear cache pop ups
    ...
    def quickedit_page(self):
        ...
        try :
            ...
            self.click_element('//*[@id="container"]/div/div[5]/table/tbody/tr[2]/td[10]/div/button/span')
            self.click_element('//*[@id="container"]/div/div[5]/table/tbody/tr[2]/td[10]/div/ul/li[1]/a')
            self.click_element('//*[@id="save"]')

            #page_title = 'page title ' + ''.join(random.choice(string.digits) for _ in range(10))
            #self.click_element('//*[@id="container"]/div/div[5]/table/tbody/tr[last()]/td[3]')
            #self.fill_textbox('//*[@id="container"]/div/div[5]/table/tbody/tr[last()]//input[2]', page_title)
    ...
    def rss_order_status_notification(self):
        ...
        try :
            ...
            if not self.check_exists_and_visible_by_xpath('//*[@id="rss_order_status"]'):
                self.click_element('//*[@id="rss_order-head"]')
    ...
    def change_store_scope(self):
        ...
        try :
            ...
            #self.click_element('/html/body/div[2]/main/div[1]/div[1]/div[1]/ul/li[4]')
            self.click_element('//a[@data-role="website-id"]')
    ...
    def change_price_scope(self):
        ...
        try :
            ...
            if not self.check_exists_and_visible_by_xpath('//*[@id="catalog_price_scope"]'):
                self.click_element('//*[@id="catalog_price-head"]')
    ...
    def configure_returnpathemail(self):
        ...
        try :
            ...
            if not self.check_exists_and_visible_by_xpath('//*[@id="system_smtp_set_return_path"]'):
                self.click_element('//*[@id="system_smtp-head"]')
    ...
    def manage_reviews(self):
        ...
        try :
            ...
            self.click_element('//*[@id="reviwGrid_table"]/tbody/tr[1]//td//a[text()="Edit"]')
            #self.click_element('/html/body/div[2]/main/div[2]/div/div/div/div[2]/table/tbody/tr[1]/td[11]/a')
    ...
    def manage_outofstocknotification(self):
        ...
        try :
            ...
            if not self.check_exists_and_visible_by_xpath('//*[@id="cataloginventory_item_options_notify_stock_qty"]'):
                self.click_element('//*[@id="cataloginventory_item_options-head"]')
    ...
    def add_product_on_homepage(self):
        ...
        try :
            ...
            self.click_element('//*[@id="container"]/div/div[5]/table/tbody/tr[3]/td[10]/div/button')
            self.click_element('//*[@id="container"]/div/div[5]/table/tbody/tr[3]/td[10]/div/ul/li[1]/a')
            self.click_element('//*[@id="page_tabs_content_section"]')
            self.click_element('//*[@id="page_content_magentowidget"]')
    ...
    def add_configurable_product(self):
        ...
        try :
            ...
            time.sleep(10)
            #self.click_element('/html/body/div[6]/aside[6]/div[2]/header/div/div/div/button[1]')
            self.click_element('//div[@class="page-main-actions"]//button/span[text()="Save"]')
            ...
            #self.click_element('//*[@id="variation-steps-wizard_step2"]/div/div[2]/div[2]/fieldset/ul/li[1]')
            #self.click_element('//*[@id="variation-steps-wizard_step2"]/div/div[2]/div[1]/div/div[2]/button[1]/span')
            self.click_element('//button[@title="Select All"]')
            self.click_element('//button[@data-bind="click: next"]')
...
Disallow: /*SID=''')
    ...
    def customer_signup(self):
        ...
        try :
            ...
            if self.wait_for_text_in_page('Account Information') == None :
                 print '[-] Test failed'
            else :
                print '[+] Test successful'
        except (NoSuchElementException, ElementNotVisibleException) as ex :
    ...
    def forgot_password(self):
        ...
        try :
            ...
            if self.wait_for_text_in_page('email') == None :
                 print '[-] Test failed'
            else :
                print '[+] Test successful'
        except (NoSuchElementException, ElementNotVisibleException) as ex :
    ...
    def customer_checkout(self):
        ...
        self.driver.get(self.main_page + '/stellar-solar-jacket.html')
        # Fill form fields
        try :
            self.click_element('/html/body/div[1]/main/div[2]/div/div[1]/div[4]/form/div[1]/div/div/div[1]/div[1]/div[1]')
            self.click_element('/html/body/div[1]/main/div[2]/div/div[1]/div[4]/form/div[1]/div/div/div[2]/div[1]/div[1]')
            self.click_element('//button[@id="product-addtocart-button"]')
            self.click_element('/html/body/div[1]/header/div[2]/div[1]/a/span[2]')
