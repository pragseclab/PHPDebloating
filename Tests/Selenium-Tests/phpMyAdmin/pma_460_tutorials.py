...
class PhpMyAdminTests:
    def __init__(self):
        # UPDATE HERE (1/5)
        self.main_page = 'http://localhost:8085/phpMyAdmin-4.6.0-all-languages/'
    ...
    def add_cookies(self):
        ...
        # UPDATE HERE (2/5)
        self.driver.add_cookie({'name': 'test_group', 'value': 'pma460_tutorials'})
        # UPDATE HERE (3/5)
        self.driver.add_cookie({'name': 'test_name', 'value': 'pma_login_pma460_tutorials'})
        # UPDATE HERE (4/5)
        self.driver.add_cookie({'name': 'software_id', 'value': '1'})
        # UPDATE HERE (5/5)
        self.driver.add_cookie({'name': 'software_version_id', 'value': '3'})
    ...
    def create_database(self):
        ...
        try :
            ...
            # Select database
            self.click_element('//a[contains(@href, "test_db") and contains(@href, "structure")]')
