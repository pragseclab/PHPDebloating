...
class PhpMyAdminTests:
    def __init__(self):
        # UPDATE HERE (1/5)
        self.main_page = 'http://localhost:8085/phpMyAdmin-4.4.0-all-languages/'
    ...
    def add_cookies(self):
        ...
        # UPDATE HERE (2/5)
        self.driver.add_cookie({'name': 'test_group', 'value': 'pma440_tutorials'})
        # UPDATE HERE (3/5)
        self.driver.add_cookie({'name': 'test_name', 'value': 'pma_login_pma440_tutorials'})
        # UPDATE HERE (4/5)
        self.driver.add_cookie({'name': 'software_id', 'value': '1'})
        # UPDATE HERE (5/5)
        self.driver.add_cookie({'name': 'software_version_id', 'value': '2'})
    ...
    def create_database(self):
        ...
        try :
            ...
            print '//a[contains(text(), \'test_db\')]'
            self.fill_textbox('//*[@id="create_table_form_minimal"]/fieldset[1]/div[1]/input', 'tbl1')
            print '//*[@id="create_table_form_minimal"]/fieldset[1]/div[1]/input'
            ...
            if not 'mysql_doc'  in self.driver.page_source :
                self.fill_textbox('//*[@id="create_table_form_minimal"]/fieldset[1]/div[1]/input', 'tbl1')
                self.fill_textbox('//*[@id="create_table_form_minimal"]/fieldset[1]/div[2]/input', '5')
                self.click_element('//*[@id="create_table_form_minimal"]/fieldset[2]/input')
            ...
            self.click_element('//span[contains(text(), "Go")]')
            time.sleep(2)
    ...
    def create_index(self):
        ...
        try :
            ...
            self.click_element('//span[contains(text(), "OK")]')
    ...
    def optimize_database(self):
        ...
        try :
            self.click_element('//a[contains(@href, "test_db") and contains(@href, "db_structure.php")]')
            self.click_element('//input[@title="Check All"]')
    ...
    def import_sql(self):
        ...
        # Fill form fields
        try :
            self.click_element('//a[contains(text(),"Import")]')
    ...
    def drop_database(self):
        ...
        # Fill form fields
        try :
            self.click_element('//a[contains(text(),"Databases")]')
