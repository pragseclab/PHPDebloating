...
class WPTest330(WPTest):
    def __init__(self):
        # UPDATE HERE (1/5)
        self.main_page = 'http://localhost:8085/WordPress-3.3/'
        super(WPTest330, self).__init__(self.main_page)
    ...
    def add_cookies(self):
        self.driver.get(self.main_page)
        # UPDATE HERE (2/5)
        self.driver.add_cookie({'name': 'test_group', 'value': 'wp330_tutorials'})
        # UPDATE HERE (3/5)
        self.driver.add_cookie({'name': 'test_name', 'value': 'wp_login_wp330_tutorials'})
        # UPDATE HERE (4/5)
...
if __name__ == '__main__':
    # Test chrome driver
    test = WPTest330()
    test.login('admin', 'zaq1@WSX', success_login_text='Dashboard')
