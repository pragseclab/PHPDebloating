...
class WPTest390(WPTest):
    def __init__(self):
        # UPDATE HERE (1/5)
        self.main_page = 'http://localhost:8085/WordPress-3.9/'
        #super().__init__(self.main_page)
        super(WPTest390, self).__init__(self.main_page)
    ...
    def add_cookies(self):
        ...
        # UPDATE HERE (5/5)
        self.driver.add_cookie({'name': 'software_version_id', 'value': '15'})
...
if __name__ == '__main__':
    ...
    test.driver.add_cookie({'name': 'test_name', 'value': 'wp_post_wp390_tutorials'})
    test.new_post_tests() if test.success else None
    test.driver.add_cookie({'name': 'test_name', 'value': 'wp_theme_wp390_tutorials'})
    test.theme_tests() if test.success else None
    test.driver.add_cookie({'name': 'test_name', 'value': 'wp_setting_wp390_tutorials'})
    test.setting_tests() if test.success else None
    test.driver.add_cookie({'name': 'test_name', 'value': 'wp_tag_wp390_tutorials'})
    test.category_tag_tests() if test.success else None
    test.driver.add_cookie({'name': 'test_name', 'value': 'wp_comment_wp390_tutorials'})
    test.comment_tests() if test.success else None
    test.driver.add_cookie({'name': 'test_name', 'value': 'wp_export_wp390_tutorials'})
    test.export('all') if test.success else None
    test.driver.add_cookie({'name': 'test_name', 'value': 'wp_user_wp390_tutorials'})
    test.user_test() if test.success else None
    test.driver.add_cookie({'name': 'test_name', 'value': 'wp_media_wp390_tutorials'})
